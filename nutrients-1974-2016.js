function NutrientsTimeSeries(){
    ...
    this.makeLegendsItem = function(label, i, color){
        var boxWidth = 50;
        var boxHeight = 10;
        var x = 800;
    ...
    this.draw = function(){
        ...
        //Loop over all rows and draw a line from the previous line to
        // the current.
        for (var i = 0; i < this.data.getRowCount(); i ++)
            {
                ...
                var labelX = this.layout.rightMargin - 150;
                var labelY = this.layout.topMargin + i * 30;
                ...
                for (var j = 1; j < numYears; j++)
                {
                    ...
                    if (previous != null){
                        ...
                        if (i % xLabelSkip == 0){
                            //##change the text size to smaller
